    ...
    try {
      ...
      while (requesting) {
        ...
        switch(choice) {
          ...
          case 4:
            System.out.println("Choose movie option: 1 - add movie, 2 - view ratings, 3 - rate movie");
            ...
            switch (movieChoice) {
              case 1:
                ...
                break;
              case 2:
                System.out.println("Enter movie name to view rating or press enter to view all ratings:");
                String movieToView = scanner.nextLine();
                json.put("task", "view");
                if (!movieToView.isEmpty()) {
              ...
              case 3:
                ...
                System.out.println("Enter your username:");
                String userToRate = scanner.nextLine();
                json.put("task", "rate");
                json.put("movie", movieToRate);
                json.put("rating", newRating);
                json.put("username", userToRate);
                break;
            }
            break;
        }
        ...
        if (res.getBoolean("ok")) {
          if (res.getString("type").equals("echo")) {
          ...
          } else if (res.getString("type").equals("add") || res.getString("type").equals("addmany")) {
            ...
            for (int j = 0; j < movies.length(); j++) {
              ...
              System.out.println("Movie: " + movie.getString("movie") + ", Rating: " + movie.getInt("rating") + ", Raters: " + movie.getJSONArray("raters"));
            }
          }
        } else {
